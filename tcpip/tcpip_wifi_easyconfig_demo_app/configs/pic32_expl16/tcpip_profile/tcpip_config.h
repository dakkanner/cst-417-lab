...
#define TCPIP_STACK_USE_DNS_SERVER			// Domain Name Service Server for redirection to the local device
                                            // Note: the service is enabled here as a special case, 
                                            // the server is needed by the Wi-Fi applications 
...
#define TCPIP_STACK_DRAM_SIZE       			(12288 * 2)
...
#define TCPIP_STACK_DRAM_DEBUG_ENABLE
    ...
    #define TCPIP_STACK_DRAM_TRACE_SLOTS    7
