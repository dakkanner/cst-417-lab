...
//-----------------------------------------------------------------
//#define APP_USE_GENERIC_TCP_CLIENT_DEMO         // Make sure to also enable TCPIP_STACK_USE_DNS and TCPIP_STACK_USE_HTTP2_SERVER in tcpip_config.h

//#define APP_USE_GENERIC_TCP_SERVER_DEMO         // Make sure to also enable TCPIP_STACK_USE_HTTP2_SERVER in tcpip_config.h

//#define APP_USE_SMTP_CLIENT_DEMO                // Make sure to also enable TCPIP_STACK_USE_HTTP2_SERVER in tcpip_config.h

//#define APP_USE_PING_DEMO                       // Make sure to also enable TCPIP_STACK_USE_ICMP_CLIENT, TCPIP_STACK_USE_ICMP_SERVER  in tcpip_config.h

//#define APP_USE_BERKELEY_API_DEMO             // Make sure to also enableTCPIP_STACK_USE_BERKELEY_API in tcpip_config.h

#define APP_USE_FTP_CLIENT_DEMO
